...
//import {RouterModule, RouterOutlet, ChildrenOutletContexts, ActivatedRoute} from './../../dyn-router/public_api';
import {RouterModule, RouterOutlet, ChildrenOutletContexts, ActivatedRoute} from '@angular/router';
...
export class DynTable implements AfterViewChecked,AfterViewInit,AfterContentInit,OnInit,OnDestroy,BlockableUI {
    ...
    constructor(public el: ElementRef, public domHandler: DomHandler, public differs: IterableDiffers,
            ...
            public zone: NgZone, private http: HttpClient, private route: ActivatedRoute) {
